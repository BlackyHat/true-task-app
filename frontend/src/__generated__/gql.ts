 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation AddCategory($createCategory: CreateCategoryInput!) {\n   addCategory(createCategory: $createCategory) {\n        id\n        name\n        dateCreated\n    }\n  }\n"): (typeof documents)["mutation AddCategory($createCategory: CreateCategoryInput!) {\n   addCategory(createCategory: $createCategory) {\n        id\n        name\n        dateCreated\n    }\n  }\n"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation UpdateCategory($updateCategory: UpdateCategoryInput!) {\n    updateCategory(updateCategory: $updateCategory) {\n          dateCreated\n          id\n          name\n    }\n  }\n"): (typeof documents)["mutation UpdateCategory($updateCategory: UpdateCategoryInput!) {\n    updateCategory(updateCategory: $updateCategory) {\n          dateCreated\n          id\n          name\n    }\n  }\n"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation Register($registerUserInput: RegisterUserInput!) {\n    register(registerUserInput: $registerUserInput) {\n      token\n      user {\n        email\n        id\n        role\n      }\n    }\n  }\n"): (typeof documents)["mutation Register($registerUserInput: RegisterUserInput!) {\n    register(registerUserInput: $registerUserInput) {\n      token\n      user {\n        email\n        id\n        role\n      }\n    }\n  }\n"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation Login($loginUserInput: LoginUserInput!) {\n    login(loginUserInput: $loginUserInput) {\n      token\n      user {\n        email\n        id\n        role\n      }\n    }\n  }\n"): (typeof documents)["mutation Login($loginUserInput: LoginUserInput!) {\n    login(loginUserInput: $loginUserInput) {\n      token\n      user {\n        email\n        id\n        role\n      }\n    }\n  }\n"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
